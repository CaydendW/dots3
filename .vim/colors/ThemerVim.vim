  ...
  let s:guishade1 = "#323540"
  let s:guishade2 = "#4f525c"
  let s:guishade3 = "#6b6e77"
  let s:guishade4 = "#878a92"
  let s:guishade5 = "#a3a6ad"
  let s:guishade6 = "#c0c3c9"
  let s:guishade7 = "#dcdfe4"
  let s:guiaccent0 = "#ed254e"
  let s:guiaccent1 = "#ed254e"
  let s:guiaccent2 = "#f9dc5c"
  let s:guiaccent3 = "#71f79f"
  let s:guiaccent4 = "#7cb7ff"
  let s:guiaccent5 = "#00c1e4"
  let s:guiaccent6 = "#ed254e"
  let s:guiaccent7 = "#7c4ded"
  ...
  let s:ctermaccent5 = 44
  let s:ctermaccent6 = 204
  let s:ctermaccent7 = 105
