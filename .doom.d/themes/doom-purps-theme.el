...
(def-doom-theme doom-purps
  ...
  ;; name        default   256       16
  ((bg         '("#161925" "#161925" nil            ))
   (bg-alt     '("#161925" "#161925" nil            ))
   ...
   (base8      '("#dcdfe4" "#dcdfe4" "white"        ))
   (fg         '("#dcdfe4" "#dcdfe4" "white"        ))
   (fg-alt     '("#dfdfdf" "#dfdfdf" "brightwhite"  ))

   (grey       base4)
   (red        '("#ED254E" "#ED254E" "red"          ))
   (orange     '("#ED254E" "#ED254E" "brightred"    ))
   (green      '("#71F79F" "#71F79F" "green"        ))
   (teal       '("#71F79F" "#71F79F" "brightgreen"  ))
   (yellow     '("#F9DC5C" "#F9DC5C" "yellow"       ))
   (blue       '("#00c1e4" "#00c1e4" "brightblue"   ))
   (dark-blue  '("#00c1e4" "#00c1e4" "blue"         ))
   (magenta    '("#7c4ded" "#7c4ded" "magenta"      ))
   (violet     '("#7c4ded" "#7c4ded" "brightmagenta"))
   (cyan       '("#7CB7FF" "#7CB7FF" "brightcyan"   ))
   (dark-cyan  '("#7CB7FF" "#7CB7FF" "cyan"         ))
